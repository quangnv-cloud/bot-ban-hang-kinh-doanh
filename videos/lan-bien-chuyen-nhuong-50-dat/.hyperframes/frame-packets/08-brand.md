...
- Project: C:\Users\Admin\Desktop\Claude\videos\lan-bien-chuyen-nhuong-50-dat
- Design tokens: C:\Users\Admin\Desktop\Claude\videos\lan-bien-chuyen-nhuong-50-dat\frame.md
- RULES_DIR: C:\Users\Admin\Desktop\Claude\.agents\skills\hyperframes-animation\rules

## Assigned storyboard block

## Frame 8 — Brand ending

- scene: Brand card tĩnh — wordmark "BOT BÁN HÀNG · KINH DOANH" + tagline "Tin kinh doanh mỗi ngày.", không CTA bán hàng.
- voiceover: ""
- duration: 2s
- transition_in: cut
- status: outline
...
- type: branding
- persuasion: Callback (return to brand identity)
- beat: satisfaction
- blueprint: titlecard-reveal (Adapt)
- focal: wordmark "BOT BÁN HÀNG · KINH DOANH"
- roles: wordmark = foreground subject (centered) · tagline "Tin kinh doanh mỗi ngày." = supporting, ngay dưới · nền ink-black phẳng = background
- sfx: chime

Adapt: chỉ 2 giây — bỏ toàn bộ chuyển động phụ, chỉ giữ MỘT hard-cut reveal rồi hold tĩnh tuyệt đối tới hết video (đây là frame cuối — exit thật, không cần transition tiếp theo).

Scene 1 (0.0–0.6s): wordmark "BOT BÁN HÀNG" (cream, ExtraBold) + "· KINH DOANH" (cam) hard-cut vào giữa khung cùng lúc, Centered.
Scene 2 (0.6–2.0s): tagline "Tin kinh doanh mỗi ngày." fade vào ngay dưới wordmark, cream, nhỏ; giữ tĩnh tuyệt đối tới hết — đây là exit thật của toàn video (không tween thoát).

narrativeRole: Đóng video bằng đúng danh tính kênh, không quảng cáo, không CTA bán hàng — chỉ tạo recognition.
keyMessage: Đây là bản tin của BOT BÁN HÀNG · KINH DOANH.
