...
- scene: Một dòng chốt duy nhất giữa khung, tối giản, không motion phụ.
...
Reproduce: đúng breather/landing beat của titlecard-reveal — MỘT move duy nhất (slide-up crossfade) rồi giữ tĩnh, không thêm chuyển động.

Scene 1 (0.0–1.2s): nhãn nhỏ "ĐIỂM CẦN THEO DÕI" (cam, uppercase mono) fade vào trên cùng.
Scene 2 (1.2–3.5s): dòng chốt "TIÊU CHÍ NHÀ ĐẦU TƯ CHIẾN LƯỢC — CHỜ CHÍNH PHỦ QUY ĐỊNH" trượt lên + crossfade vào giữa khung, cream, "CHÍNH PHỦ" tô cam — khớp lúc VO nói dòng tương ứng.
Scene 3 (3.5–5.0s): giữ nguyên, subtle jitter duy nhất tới hết frame — không thêm move nào khác (đúng nguyên tắc "một move rồi giữ tĩnh" của titlecard-reveal).

narrativeRole: Chốt câu chuyện bằng một điều còn bỏ ngỏ — cho người xem lý do để tiếp tục theo dõi kênh.
